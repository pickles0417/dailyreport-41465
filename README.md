...
- [ユーザーマイページ](https://gyazo.com/92a40a79dc2739152b582ffff1dd27d1 "ユーザーマイページ")<br>
1.トップページのヘッダーにある「ユーザー名」をクリックしプルダウンの「マイページ」をクリック<br><br>

- [顧客登録](https://gyazo.com/cdf47bd11117e9b6cb430d4bea61b5f8 "顧客登録")<br>
1.トップページのヘッダーにある「メニュー」をクリックしプルダウンの「顧客登録」をクリック<br>
2.入力フォームに遷移されるので必要な情報を入力し、「登録する」を押すとトップページ一覧に反映<br><br>

- [顧客詳細](https://gyazo.com/af0c9c2ecc87f748925126b20ea2ebbd "顧客詳細")<br>
1.トップページ顧客一覧から顧客情報列の「詳細」ボタンをクリックし詳細画面に遷移<br><br>

- [顧客検索機能](https://gyazo.com/9305a0ee4b7375cdec5916cfa43a7017 "顧客検索機能")<br>
1.トップページのヘッダー右側検索ファームに顧客名を入力し「検索」ボタンをクリック<br><br>

- [顧客編集](https://gyazo.com/0977041a25f2e3ecdbb51c09f1556ae5 "顧客編集")<br>
1.顧客詳細ページから「編集」ボタンをクリックし、フォーム入力後、更新された詳細ページに遷移<br><br>

- [顧客に紐づく商談履歴](https://gyazo.com/6597a5340f798637c8a288e0004149c0 "顧客に紐づく商談履歴")<br>
1.トップページ顧客一覧から商談履歴列の「詳細」ボタンをクリックし商談履歴画面に遷移<br><br>

- [商談登録](https://gyazo.com/340818aa9fa7680510ef0d8d61ab31a7 "商談登録")<br>
1.商談履歴画面の下部「商談入力」ボタンをクリックし、フォーム入力と「登録する」ボタンをクリック後、更新された商談履歴画面に遷移<br><br>
